...
async function initDB() {
  ...
  // Backfill CA lien alerts for existing projects that have none — non-fatal
  try {
    await pool.query(`
    ...
    `);
    console.log('[Lien] CA backfill complete');
  } catch (e) {
    console.warn('[Lien] CA backfill skipped:', e.message);
  }
